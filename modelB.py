...
def prepare_data(csv_file, lookahead=30, window_size=300000):
    """
...
def train_and_predict(csv_file, window_size=300000):
    """
    Trains the model and predicts the probability of price going up or down.
    """
    # Prepare the data
    X, y = prepare_data(csv_file, window_size=window_size)
